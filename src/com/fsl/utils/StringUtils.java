...
public class StringUtils {
    ...
    /**
     * 
     * @Title: StringToInt @Description:string -> int @param @param
     *         str @param @return @return int @throws
     */
    ...
    /**
     * 
     * @Title: StringToShort @Description: string -> short @param @param
     *         str @param @return 参数说明 @return short 返回类型 @throws
     */
    ...
    /**
     * 
     * @Title: StringToLong @Description:string -> long @param @param
     *         str @param @return @return int @throws
     */
    ...
    /**
     * 
     * @Title: isNumeric @Description:判断字符串是数字 @param @param
    ...
    /**
     * 
     * @Title: getStringList @Description:将(逗号)分隔的字符串 将分隔成list @param @param
     *         str @param @return @return List<String> @throws
     */
    ...
    /**
     * 
     * @Title: saveTwoDecimal @Description:保留两位小数 @param @param
     *         price @param @return @return double @throws
     */
     ...
     *         $1****$3 ->138****5678 @param @param value @param @param
    ...
    /**
     * 
     * @Title: StringToDouble @Description:格式化 double字符串,去掉, @param @param
     *         str @param @return @return double @throws
     */
    ...
    /**
     * 
     * @Title: equalsByRegex @Description:根据正则表达式 匹配字符串 @param @param
     *         value @param @param regex @param @return @return boolean @throws
     */
    ...
    /**
     * 
     * @Title: decode @Description: 处理编码 和特殊字符(% +) @param @param
     *         data @param @return 参数说明 @return String 返回类型 @throws
     */
